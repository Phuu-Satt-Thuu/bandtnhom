...
- Có thể tìm hiểu thêm về những quảng cáo hiện diện trên trang. 
...
- Có thể cập nhật chức năng bản đồ hiện diện trên web.
...
- Danh sách **khách hàng**, tìm kiếm/lọc, thêm/xoá/khoá khách hàng
